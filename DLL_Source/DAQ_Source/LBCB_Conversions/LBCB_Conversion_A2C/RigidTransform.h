...
void RigidTransform( const VECTOR &ref_point, const VECTOR &ref_value, const VECTOR &target_point, VECTOR &target_value )
{
	...
	VECTOR temp(3), temp_vec(3), temp_moment(3);
	RotationalMatrix Roll( 0, 1 );  // Roll
	RotationalMatrix Pitch( 0, 2 ); // Pitch
	RotationalMatrix Yaw( 0, 3 );   // Yaw
