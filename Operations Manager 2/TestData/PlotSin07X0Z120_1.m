...
subplot(312)
plot(data(:,25),data(:,33),'o-','MarkerSize',2)
grid on
axis([-0.8 0.8 50 150])
xlabel('Disp. X (in)')
ylabel('Force Z (lb)')
...
subplot(313)
plot(data(:,25),data(:,27),'o-','MarkerSize',2)
grid on
axis([-0.8 0.8 0 0.2])
xlabel('Disp. X (in)')
ylabel('Disp .Z (in)')
