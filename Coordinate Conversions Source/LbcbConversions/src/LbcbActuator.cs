...
namespace LbcbConversions
{
    public class LbcbActuator
    {
        ...
        {
            DenseMatrix rotTrig = new DenseMatrix(3, 2);
            rotTrig[0, 0] = Math.Sin(cartesian[3]);
            rotTrig[0, 1] = Math.Cos(cartesian[3]);
            rotTrig[1, 0] = Math.Sin(cartesian[4]);
            rotTrig[1, 1] = Math.Cos(cartesian[4]);
            rotTrig[2, 0] = Math.Sin(cartesian[5]);
            rotTrig[2, 1] = Math.Cos(cartesian[5]);
            ...
            DenseMatrix J = new DenseMatrix(3, 3);
            // Jacobian Element
            J[0, 0] = 0;
        ...
        public void update(double[] cartesian)
        {
            ...
            DenseMatrix r = roll.create(cartesian[4]);
            DenseMatrix p = pitch.create(cartesian[5]);
            DenseMatrix y = yaw.create(cartesian[6]);
