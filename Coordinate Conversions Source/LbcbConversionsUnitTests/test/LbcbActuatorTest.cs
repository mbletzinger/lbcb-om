...
namespace LbcbConversionsUnitTests.test
{
    ...
    {
        private TransducerPinLocationData l1pins;
        private TransducerPinLocationData l2pins;
        [Test]
        [Category("CI")]
        public void test01PinPositions()
        {
            double[] lengths = new double[] { 72.9711, 72.9711, 55.9129, 56, 56, 56 };
            DispTransducer[] pins1 = l1pins.getActuators();
            DispTransducer[] pins2 = l2pins.getActuators();
            for (int a = 0; a < 6; a++)
            {
        ...
        public void setup()
        {
            l1pins = new TransducerPinLocationData(Assembly.GetExecutingAssembly());
            l2pins = new TransducerPinLocationData(Assembly.GetExecutingAssembly());
