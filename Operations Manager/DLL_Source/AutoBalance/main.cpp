...
extern "C" {
_declspec(dllexport) void AutoBalanceController(double ServoError[], double BalanceGain[], double SafeRange[], double Command[], double BestCommand[], double MinError[], long *AutoBalance, long *index);
}
